defmodule ExAuth.Plug.AbsintheContext do
  ...
  def call(conn, _) do
    ...
    case Code.ensure_compiled(Absinthe.Plug) do
      {:module, absinthe_plug} ->
        case build_user_context(conn) do
          %{current_user: _} = context ->
            absinthe_plug.put_options(conn, %{context: context})
  ...
  defp authorize(token, type, project_name)
